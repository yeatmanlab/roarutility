...
This is a basic example which shows you how clean_strings() takes in data and spits out data that has removed extra characters from assigning organization variables and converted empty strings to NA values.
